...
namespace MVCRecipesSite.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RecipeId,Name,Ingredients,Directions,PrepTime,Calories")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecipeId,Name,Ingredients,Directions,PrepTime,Calories")] Recipe recipe)
        {
